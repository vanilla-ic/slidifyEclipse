...
Please try out the app  http://vanilla-ic.shinyapps.io/DevDataProdProject
...
library(maps)
data <- readRDS("eclipse.rds")
data <- data[data$year>= 1901 & data$year<= 2000, ]
data <- data[data$ecType == "Total", ]
